# Pinned Pi vendor docs — `@earendil-works/pi-coding-agent@0.84.2`
...
mode, the CLI binary, the TUI, `pi install` packages, or skills / prompt /
theme discovery.
...
`skills.md`, `prompt-templates.md`, `themes.md`, `packages.md`,
`keybindings.md`, and platform setup guides. Those are for the interactive
CLI and for non-Node hosts. Copying them here would point agents at the
wrong integration.
