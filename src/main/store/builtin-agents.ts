...
export const BUILTIN_AGENTS: AgentDef[] = [
  ...
  },
  {
    ...
    userPrompt: [
      ...
      'then report. List every file you changed, including deletions.',
    ].join('\n'),
  },
  {
    name: 'scout',
  ...
  },
  {
    ...
    customFields: [
      ...
      },
      {
        ...
        type: 'string[]',
        required: false,
        description: 'every file you changed while closing gaps, one per entry',
      },
    ],
    systemPrompt: [
      '# Finisher',
    ...
    userPrompt: [
      ...
      '2. List what you changed in `improvements`, and every file you touched in `changed_files` — a gate checks that list against git.',
