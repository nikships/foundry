...
export const BUILTIN_AGENTS: AgentDef[] = [
  ...
  },
  {
    ...
    systemPrompt: [
      ...
      '## Instructions',
      '',
      '- You are read-only, and you have no shell: work from the accumulated git context below and read the files it names.',
      '- Derive requirements from the request and the plan, then check each one against those files.',
  ...
  },
  {
    ...
    systemPrompt: [
      ...
      '',
      '- You are read-only. Do not create, edit, or delete any file.',
      '- You have no shell either. Work from the accumulated git context below (branch, base ref, branch point, changed-file stat), the files it names, and prior envelopes. Focus on why, what, and how it was verified.',
    ...
    userPrompt: [
      ...
      'what happened.',
      '',
      '1. Read the accumulated git context below, then read the changed files it names.',
