...
- **Discovery stays off for tools and prompts.** Extensions, skills, prompt templates, themes, and appended system prompts do not come from the user’s pi installation or a checkout’s `.pi/`. Context files (`AGENTS.md` walking from cwd) are loaded.
