...
export const SMITH_CHAT_HARNESS = [
  ...
  '  catalogs of entities or runs in a typed data table, or to disclose context',
  '  occupancy and evidence excerpts: the card renders structured definitions',
  '  and receipts far better than prose or a JSON block.',
