...
export const SMITH_CHAT_HARNESS = [
  ...
  '## Presenting designs',
  '',
  '- `smith_present` shows the operator a rich inline design card. Use it',
  '  whenever you have designed or are about to propose a non-trivial',
  '  pipeline, agent, or envelope: the card renders phases, agents, gates,',
  '  boundaries, and envelopes far better than prose or a JSON block.',
