...
export const SMITH_CHAT_HARNESS = [
  ...
  '  pipeline, agent, or envelope, and for `run_summary` when reporting on',
  '  run status, progress, or outcomes: the card renders phases, agents, gates,',
  '  boundaries, envelopes, and run waterfalls far better than prose or JSON.',
  ...
  '  revised design, and say plainly what changes before proposing.',
