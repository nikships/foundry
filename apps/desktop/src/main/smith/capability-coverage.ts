...
export const SMITH_CAPABILITY_COVERAGE: Readonly<Record<string, SmithCapabilityCoverage>> = {
  ...
  // not even Smith's — and session create is renderer-only, so state and
  // create are not Smith tool operations.
  [IPC.gptLiveState]: read('smith_providers', 'gpt_live_state'),
  [IPC.gptLiveSetApiKey]: secure('smith_providers', 'gpt_live_set_api_key'),
  [IPC.gptLiveClearApiKey]: approve('smith_providers', 'gpt_live_clear_api_key'),
  [IPC.gptLiveCreateSession]: secure('smith_providers', 'gpt_live_create_session'),
  ...
  [IPC.runsAgents]: read('smith_runs', 'agents'),
  [IPC.runsConversation]: read('smith_runs', 'conversation'),
  [IPC.runsMessages]: read('smith_runs', 'messages'),
  [IPC.runsMessagePhase]: approve('smith_runs', 'message_phase'),
  [IPC.runsInterruptPhase]: approve('smith_runs', 'interrupt_phase'),
  ...
  [IPC.smithComposeStart]: read('smith_compose', 'compose'),
  [IPC.smithComposeRevise]: read('smith_compose', 'revise'),
  [IPC.smithComposeCancel]: approve('smith_compose', 'cancel'),
  [IPC.smithComposeList]: read('smith_compose', 'list'),
  [IPC.smithComposeGet]: read('smith_compose', 'get'),
  [IPC.smithComposeAccept]: approve('smith_compose', 'accept'),
  [IPC.smithComposeDiscard]: approve('smith_compose', 'discard'),
