...
export const AGENTS: Agent[] = [
  ...
  {
    name: 'pr_writer',
    tagline: 'Opens the PR',
    purpose:
      'Commit remaining work, push the run branch, and open a concise, template-aware pull request.',
    report: 'pr',
    effort: 'medium',
    toolProfile: 'full',
    writes: null,
    color: '#f59e0b',
    prompt:
      'Commit remaining run changes on the shared pipeline branch, push it, then locate a PR template and compose a bounded title and body.',
  },
  {
    name: 'issue_writer',
...
export const PIPELINES: Pipeline[] = [
  ...
  },
  {
    ...
    phases: 4,
    chain: ['diagnose', 'fix', 'test', 'open_pr'],
  },
  {
    id: 'spec-pr',
    name: 'Spec → PR',
  ...
  },
  {
    ...
    phases: 4,
    chain: ['diagnose', 'file_issue', 'spec', 'open_pr'],
  },
  {
    id: 'ship-pr',
  ...
  },
  {
    id: 'sdlc-pr',
    name: 'Full SDLC → PR',
    desc: 'Refine, plan, build, test, polish, re-test, review, and document, then commit, push, and open the pull request.',
    phases: 9,
    chain: [
      'refine',
      'plan',
